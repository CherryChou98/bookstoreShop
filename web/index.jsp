    ...
    <div class="container">
      <div class="row">
        ...
        <div class="links span8">
          <a class="login" href="login.jsp" rel="tooltip" data-placement="bottom" data-toggle="modal" data-target="#myModal"></a>
          <a class="register" href="register.jsp" rel="tooltip" data-placement="bottom" ></a>
          <a class="logout" href="" rel="tooltip" data-placement="bottom"></a>
        </div>
      </div>
    </div>
  </div> <%--header--%>
